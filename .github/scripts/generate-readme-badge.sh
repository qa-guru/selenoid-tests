#!/usr/bin/env bash
# SSOT: generators/ethalon/readme/generate-readme-badge.sh
# Sync copy → consumer .github/scripts/generate-readme-badge.sh (selenoid-tests, reference pyramid, …)
#
# Usage:
...
STACK_FOOTER="${7:-Go 1.27 · Allure 3}"
OUTPUT_SUFFIX="${8:-}"

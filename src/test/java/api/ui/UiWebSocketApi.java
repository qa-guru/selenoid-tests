...
public final class UiWebSocketApi {

    private UiWebSocketApi() {
    }

    @Step("UI WebSocket {path} — expect open")
    public static void openBriefly(String path, Duration timeout) throws Exception {
        ...
        HttpClient.newHttpClient()
                ...
                .buildAsync(uiWebSocketUri(path), new WebSocket.Listener() {
                    @Override
    ...
    public static URI uiWebSocketUri(String path) {
        var http = UiRequest.baseUri();
